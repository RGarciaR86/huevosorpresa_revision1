...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        HuevoSorpresaGarciaRivasRaul2122 h_sorpresa;
       
        
        h_sorpresa=new HuevoSorpresaGarciaRivasRaul2122(10,5,"peluche",10);
        opera_PrecioGarciaRivasRaul2122(h_sorpresa);
        
        opera_UnidadesGarciaRivasRaul2122(h_sorpresa);
        
    }

    public static void opera_UnidadesGarciaRivasRaul2122(HuevoSorpresaGarciaRivasRaul2122 h_sorpresa) {
    ...
    public static void opera_PrecioGarciaRivasRaul2122(HuevoSorpresaGarciaRivasRaul2122 h_sorpresa) {
